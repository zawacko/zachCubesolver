...
public class OldPochmannMethod
    ...
    String getEdgeToBeSolved(){
        char b = cube.cubeColors[UP_FACE_INDEX][1][2];//TODO done
        char m = cube.cubeColors[RIGHT_FACE_INDEX][0][1];//TODO done
    ...
    public void solveEdges() {
        HashSet<String> unsolvedEdges = createUnsolvedEdges();//TODO done
        while (unsolvedEdges.size()>0 && !cube.areEdgesSolved()) {//TODO done
            System.out.println("num unsolved edges: " + unsolvedEdges.size());
            String faceColor = getEdgeToBeSolved();//TODO done

            System.out.println("faceColor: " + faceColor);
            while (!"WR".equalsIgnoreCase(faceColor) && !"RW".equalsIgnoreCase(faceColor)) {//TODO done
                //TODO done
                ...
                faceColor = getEdgeToBeSolved();//TODO done
